    ...
    <nav className="menu-navigation">
      <div className="nav-left">
        <div className="logo-container">
          <a href="/menu.html#/strona-główna" className='link-navigation-menu'>
        ...
        <div className="nav-options">
          ...
          <span className="profile-text">
            <a href="/menu.html#/seriale" className='link-navigation-menu'>
            <Text className="nav-text-options">Seriale</Text>
            </a>
          </span>
          <span className="profile-text">
            <a href="/menu.html#/filmy" className='link-navigation-menu'>

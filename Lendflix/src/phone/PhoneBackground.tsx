...
function PhoneBackground(){
    return(
        ...
        <Text className='phone-page-title'>Zmień numer telefonu komórkowego</Text>
        <Text className='phone-page-title-small'>Netflix korzysta z Twojego numeru telefonu do przesyłania ważnych informacji o koncie, na przykład aby ułatwić 
                                                 Ci odzyskanie konta lub uzyskanie do niego dostępu. Zaraz wyślemy Ci kod, aby potwierdzić Twój numer.</Text>
        </div>
